...
function toDTO(doc: AnyDoc): OrganizationSettings {
  ...
  return {
    ...
    registeredAddress: {
      line1: (d.registeredAddress as Record<string, string>)?.line1 ?? "",
      line2: (d.registeredAddress as Record<string, string>)?.line2 ?? "",
      city: (d.registeredAddress as Record<string, string>)?.city ?? "",
      state: (d.registeredAddress as Record<string, string>)?.state ?? "",
      postcode: (d.registeredAddress as Record<string, string>)?.postcode ?? "",
      country: (d.registeredAddress as Record<string, string>)?.country ?? "",
    },
    registeredAddressLabel: (d.registeredAddressLabel as string) ?? "",
