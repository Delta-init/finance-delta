  ...
  return (
    <div className="grid h-screen w-full max-w-full overflow-hidden bg-surface lg:grid-cols-2">
      <div className="relative flex flex-col px-6 py-8 sm:px-10 lg:px-12">
        {/* The wordmark already reads "delta", so no text beside it. Plain
            <img> because next/image wants width and height it cannot infer for
            a decorative mark that only ever renders at one size. */}
        <img
          src="/delta-wordmark.webp"
          alt="Delta Finance"
